...
const PlumberRegistration = () => {
  ...
  const [formData, setFormData] = useState({
    basicInfo: {
      ...
      streetNumber: '',
      postcode: '',
      city: '', // Added for town hall/city
      province: '', // Already present but explicitly required
      vatNumber: '',
      isCompany: false, // Added to support company registration
      ownerInfo: {
        firstName: '',
        lastName: '',
        email: '',
        phone: '',
        city: '', // Added for owner’s city
        province: '', // Added for owner’s province
        zipCode: '' // Already present, renamed from postcode for consistency
      },
      logo: null
    },
    businessDescription: '',
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-2">
              <input
                type="checkbox"
                id="isCompany"
                checked={formData.basicInfo.isCompany}
              ...
              />
              <label htmlFor="isCompany" className="text-sm font-medium">Register as a Company</label>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  className="w-full max-w-full p-3 border rounded-lg focus:ring-2 focus:ring-blue-500"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <label className="block text-sm font-medium mb-2">Postcode (CAP)</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium mb-2">City (Town Hall)</label>
                <input
                  type="text"
                ...
                />
                {!formData.basicInfo.city && formData.basicInfo.streetNumber && (
              ...
              <div>
                ...
                {!formData.basicInfo.province && formData.basicInfo.streetNumber && (
                  <p className="text-red-500 text-sm mt-1">Please enter the province</p>
                )}
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="Enter city"
                  />
                  {!formData.basicInfo.ownerInfo.city && formData.basicInfo.ownerInfo.phone && (
                    <p className="text-red-500 text-sm mt-1">Please enter the city</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  />
                  {!formData.basicInfo.ownerInfo.province && formData.basicInfo.ownerInfo.phone && (
                ...
                <div>
                  ...
                  />
                  {!formData.basicInfo.ownerInfo.zipCode && formData.basicInfo.ownerInfo.phone && (
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full max-w-full p-3 border rounded-lg"
                    />
                  </div>
                  <div>
          ...
          <div className="space-y-4">
            <div className="relative">
              ...
              <input
                ...
                className="w-full max-w-full p-3 pl-10 border rounded-lg"
                onChange={(e) => {
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full max-w-full p-3 pl-8 border rounded-lg"
