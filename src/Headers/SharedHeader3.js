...
import {
  Bell, ChevronDown, Globe, Languages, User, Bookmark, LogOut, 
  Settings, Shield, Star, CreditCard, Heart, Mail, HelpCircle, 
  FileText, Info, MessageCircle, DollarSign, MessageSquare, Briefcase
} from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-4">
            <a href="/internationalhompage" className="flex items-center gap-2">
              <img 
